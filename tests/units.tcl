...
unitt::suite "queue" {
    {
        set mrfclip::queue {}
        set edge1 [mrfclip::create_edge [mrfclip::point init {0 0}] [mrfclip::point init {10 10}] SUBJECT]
        set edge2 [mrfclip::create_edge [mrfclip::point init {10 10}] [mrfclip::point init {-10 10}] SUBJECT]
        set e1 [lindex $edge1 0]
        set e2 [lindex $edge1 1]
        set e3 [lindex $edge2 0]
        set e4 [lindex $edge2 1]
        set q [mrfclip::queue_insert $e1]
        unitt::assert_eq $q [list $e1]
        set q [mrfclip::queue_insert $e2]
        unitt::assert_eq $q [list $e1 $e2]
        set q [mrfclip::queue_insert $e3]
        unitt::assert_eq $q [list $e1 $e2 $e3]
        set q [mrfclip::queue_insert $e4]
    ...
    }
    {
        ...
        set mrfclip::queue {}
        set events {}
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {10 10}] [mrfclip::point init {10 0}] SUBJECT]
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {0 0}] [mrfclip::point init {10 0}] SUBJECT]
        foreach event $events {
            set q [mrfclip::queue_insert $event]
        }
        unitt::assert_eq $q \
        [list \
            [lindex $events 2] \
    ...
    }
    {
        ...
        set events {}
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {10 10}] [mrfclip::point init {10 0}] SUBJECT]
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {10 20}] [mrfclip::point init {10 0}] CLIPPING]
        foreach event $events {
            set q [mrfclip::queue_insert $event]
        }
    ...
    }
    {
        ...
        set mrfclip::queue {}
        set events {}
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {0 10}] [mrfclip::point init {10 10}] SUBJECT]
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {0 20}] [mrfclip::point init {10 0}] SUBJECT]
        foreach event $events {
            set q [mrfclip::queue_insert $event]
        }
        # the two right endpoints on the same X should insert simply in the
    ...
    }
    {
        ...
        set events {}
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {0 0}] [mrfclip::point init {10 0}] SUBJECT]
        lappend events {*}[mrfclip::create_edge [mrfclip::point init {0 0}] [mrfclip::point init {20 0}] SUBJECT]
        foreach event $events {
            set q [mrfclip::queue_insert $event]
        }
        unitt::assert_eq $q \
